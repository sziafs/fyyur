...
def venues():
  ...
  venues_san_francisco = Venue.query.filter_by(city='San Francisco').all()
  venues_newyork = Venue.query.filter_by(city='New York').all()
  data=[{
    "city": "San Francisco",
    "state": "CA",
    "venues": venues_san_francisco
  }, {
    "city": "New York",
    "state": "NY",
    "venues": venues_newyork
  }]
