...
from artist import artists, search_artists, show_artist, edit_artist, edit_artist_submission, create_artist_form, create_artist_submission
...
artist_bp.route('/create', methods=['GET'])(create_artist_submission) 
artist_bp.route('/create', methods=['POST'])(create_artist_form)